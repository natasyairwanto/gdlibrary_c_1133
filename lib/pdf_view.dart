...
import 'package:gdlibrary_c_1133/invoice/get_total_invoice.dart';
import 'package:gdlibrary_c_1133/invoice/model/custom_row_invoice.dart';
import 'package:gdlibrary_c_1133/invoice/model/product.dart';
import 'package:barcode_widget/barcode_widget.dart';
import 'package:gdlibrary_c_1133/preview_screen.dart';
import 'package:gdlibrary_c_1133/invoice/item_doc.dart';
...
(
  ...
  final formattedDate = DateFormat('yyyy-MM-dd HH:mm:ss').format(now); //menampilkan waktu terbuatnya dokumen pdf

  //mengambil gambar dari asset untukk ditampilkan pada dokumen PDF untuk header dokumen pdf dan logo untuk invoicenya
  ...
  //Peletakan urutan hasil isi atau value baris invoicenya sesuai yang telah menggunakan list
  ...
  final List<CustomRow> elements = [
    ...
    CustomRow(
      ...
      "",
      "",
      "Rp ${getSubTotal(soldProducts)}", //memanggil fungsi yang ada pada file get_total_invoice.dart
    ),
    CustomRow(
      "PPN Total(11%)",
      "",
      "",
      "Rp ${getPPNTotal(soldProducts)}", //memanggiil fungsi yang ada pada file get_total_invoice.dart
    ),
    CustomRow(
      "Total",
      "",
      ...
      double.parse(getPPNTotal(soldProducts))).toStringAsFixed(2)}", //memanggil fungsi yang ada pada file get_total_invoice.dart
    )
  ];
  
  pw.Widget table = itemColumn(elements);

//pengaturan tampilam dokumen PDFnya
//Di sini menggunakan Multi Page agar dapat menampilkan lebih dari 1 halaman.
//kemudian menggunakan header dokumen PDF, build untuk isi dokumen PDFnya, dan footer untuk footer dokumen PDF
  doc.addPage(
    pw.MultiPage(
      pageTheme: pdfTheme,
          ...
          pw.Center(
            child: pw.Column(
              ...
              children: [
                ...
                //Bagian halaman PDF yg menampilkan data personal berupa sebuah tabel yg sudah diinputkan pada halaman input
                personalDataFromInput(nameController, phoneController, addressController),
                pw.SizedBox(height: 10.h), //white space untuk jeda

                //Bagian PDF yg menampilkan invoice
...
pw.Padding personalDataFromInput(TextEditingController nameController, TextEditingController phoneController, TextEditingController addressController) {
 return pw.Padding(
		padding:
...
pw.Padding contentOfInvoice(pw.Widget table) {
  return pw.Padding(
    ...
    child: pw.Column(children: [
      ...
      table, //Tabel yg sudah diatur tampilannya di dalam file item_doc.dart
...
pw.Center footerPDF(String formattedDate) =>
  pw.Center(child: pw.Text('Created At $formattedDate', style: pw.TextStyle(fontSize: 10.sp, color: PdfColors.blue)));